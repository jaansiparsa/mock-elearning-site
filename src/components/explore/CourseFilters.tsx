...
export default function CourseFilters({ searchParams }: CourseFiltersProps) {
  ...
  const clearFilters = () => {
    ...
    updateFilters({ category: "all", difficulty: "all", search: "" });
  };
  ...
  return (
    <div className="space-y-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-1 md:space-y-2">
      ...
      {/* Difficulty Filter - Horizontal on mobile, vertical on desktop */}
      <div>
        <h3 className="mb-3 text-sm font-medium text-gray-900">
          Difficulty Level
        </h3>
        <div className="grid grid-cols-3 gap-2 md:grid-cols-1 md:space-y-2">
